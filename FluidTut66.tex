...
\addpic{Becken mit solider Füllung}
...
\addpic{Becken im Plugin definiert}
...
\addpic{Ein erster Testrender}
%}}}

\subsection{Weiterführende Optionen zum letzten Beispiel}
%{{{
Was es sonst noch so die bis jetzt besprochenen Objekte betreffend gibt.
%}}}

\subsection{Mehr Flüssigkeit dazugießen (\fachb{Emitters})}
%{{{
Kommt noch.
%}}}
