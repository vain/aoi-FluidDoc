...
$8$). Damit die Körper auch schön ">soft"< aussehen, setzen wir ihre
Smoothing Method auf ">Approximating"< -- und damit wir sie auch leicht
auseinanderhalten können, bekommen sie zwei unterschiedliche Texturen.
Zuguterletzt drehen wir die beiden noch ganz leicht, um eine gewisse
Anfangsstörung in das System zu bringen (es ist meistens relativ
langweilig, Objekte perfekt nach unten fallen zu lassen).
Abbildung~\ref{fig:rampe1} zeigt ein solches Setup.
