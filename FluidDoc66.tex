...
\itA
	...
	diesen Haken nicht entfernen und schätzungsweise wird diese Option
	...
	geringe Kraft auf das Partikel, sofern es in der Nähe ist.
	...
	das System gebracht, indem das Hindernis Partikel in der Nähe leicht
	abstößt. Dies sollte nur benutzt werden, wenn ">Calculate boundary
	...
	Will man dagegen ermöglichen, dass Partikel stark abprallen, so muss
	dieser Wert recht hoch angesetzt werden (im Zweifelsfalle auf
	">1000"< oder mehr).

	\item ">\textbf{Boundary Friction}"<: Dieser Wert tut genau das,
	was sein Name vermuten lässt -- er steuert die Reibung, die auf
	dieser Oberfläche wirkt. Hierbei gibt es nicht allzu viel zu
	beachten. Je höher dieser Wert, desto größer ist die Reibung. Man
	muss allerdings selbst etwas experimentieren, wenn man gezielt
	bestimmte Materialien simulieren will.

	TODO: Was genau steuert boundary friction und wie sieht die formel
	dazu aus?
